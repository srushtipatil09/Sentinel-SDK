...
export const Dashboard = () => {
  ...
  if (isLoading) {
    return <LoadingState label="Loading Observe AI system health & active incidents..." type="skeleton" count={4} />;
  }
          ...
          <div className="p-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm text-center space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-md mx-auto">
                {hasZeroProjects
                  ? 'Create a project and connect the Observe AI SDK to start monitoring telemetry and automated RCA.'
                  : 'Active Observe AI SDK telemetry will automatically trigger multi-agent RCA upon operational anomalies.'}
              </p>
            </div>
            <button
              onClick={() => {
