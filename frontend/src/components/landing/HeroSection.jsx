      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto font-normal leading-relaxed">
            Observe AI monitors your application&apos;s telemetry, detects incidents, and uses autonomous AI agents to identify root causes and recommend fixes before your team has to dig through thousands of logs.
          </p>
