      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-base text-slate-400">
            Observe AI doesn&apos;t rely on a single generic AI prompt. Instead, a swarm of domain-specific AI agents collaborate to investigate every angle of production failures.
          </p>
        </div>
