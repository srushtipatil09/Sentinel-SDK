  ...
  const steps = [
    {
      num: '01',
      title: 'Connect SDK',
      desc: 'Developer integrates the lightweight Observe AI SDK into their Node.js or Python application in under 2 minutes.',
      icon: Code,
      color: 'text-blue-400',
      bg: 'bg-blue-500/10',
    ...
    },
    {
      ...
      desc: 'Observe AI evaluates incoming telemetry and automatically triggers incidents on error spikes, uncaught exceptions, or latency breaches.',
      icon: ShieldAlert,
