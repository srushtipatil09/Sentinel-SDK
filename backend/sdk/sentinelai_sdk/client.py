...
logger = logging.getLogger("sentinelai_sdk")


class SentinelAISDKClient:
    """
    Python SDK Client implementation demonstrating auto-buffering,
    retry logic, and batch upload to the Sentinel AI backend ingestion API.
    """
